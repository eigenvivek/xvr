...
from .dicom import _parse_dicom, _parse_dicom_pose, _preprocess_xray
...
class Registrar:
    def __init__(
        ...
        self.imagesim = lambda x, y: imagesim1(x, y)
    ...
    def run(self, i2d):
        ...
        gt, sdd, delx, dely, x0, y0, init_pose = initialize_pose(
            i2d,
            self.crop,
...
def initialize_pose(
    ...
    init_pose = _parse_dicom_pose(i2d, orientation).cuda()
