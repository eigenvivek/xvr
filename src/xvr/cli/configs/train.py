...
class TrainParams:
    ...
    volpath: Annotated[
        str,
        Parameter(
            name=["--volpath", "-v"], help="CT or directory of CTs for pretraining", group=_DATA
        ),
    ]
    outpath: Annotated[
        str,
        Parameter(
            name=["--outpath", "-o"], help="Directory in which to save model weights", group=_DATA
        ),
    ]
    ...
    maskpath: Annotated[
        ...
        Parameter(
            name=["--maskpath", "-m"],
            help="Optional labelmaps corresponding to the CTs",
            group=_DATA,
        ),
    ] = None
    ...
    img_threshold: Annotated[
        float,
        Parameter(help="Minimum fraction of foreground pixels to keep a DRR", group=_SAMPLING),
    ] = 0.10
    mask_threshold: Annotated[
        float, Parameter(help="Minimum fraction of mask pixels to keep a DRR", group=_SAMPLING)
    ] = 0.05
