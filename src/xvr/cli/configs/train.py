...
class TrainParams:
    ...
    use_compile: Annotated[bool, Parameter(help="Compile forward pass with max-autotune-no-cudagraphs", group=_MODEL)] = False
    ...
    n_save_every_itrs: Annotated[int, Parameter(help="Number of iterations before saving a new model checkpoint", group=_OPTIMIZER)] = 1_000
    disable_scheduler: Annotated[bool, Parameter(help="Turn off cosine learning rate scheduler", group=_OPTIMIZER)] = False
