...
class BaseParams:
    ...
    patience: Annotated[list[int] | int, Parameter(help="Number of steps with no improvement before reducing the learning rate (can be defined per-scale)", group=_OPTIMIZER)] = 5
