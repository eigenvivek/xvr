...
from ...config.registrar import args
...
class BaseRegistrar(CategorizedCommand):
    default_params = [
        ...
        CategorizedOption(
            ["--subtract_background"],
            default=args.subtract_background,
            is_flag=True,
