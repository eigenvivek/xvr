...
class Trainer:
    def __init__(
        ...
        unit_conversion_factor=cfg.unit_conversion_factor,
        p_augmentation=cfg.p_augmentation,
        lr=cfg.lr,
        weight_ncc=cfg.weight_ncc,
        weight_geo=cfg.weight_geo,
        weight_dice=cfg.weight_dice,
        weight_mvc=cfg.weight_mvc,
        batch_size=cfg.batch_size,
        n_total_itrs=cfg.n_total_itrs,
        n_warmup_itrs=cfg.n_warmup_itrs,
        n_grad_accum_itrs=cfg.n_grad_accum_itrs,
        n_save_every_itrs=cfg.n_save_every_itrs,
        disable_scheduler=cfg.disable_scheduler,
        ckptpath=None,
        reuse_optimizer=cfg.reuse_optimizer,
        warp=None,
        invert=False,
        patch_size=None,
